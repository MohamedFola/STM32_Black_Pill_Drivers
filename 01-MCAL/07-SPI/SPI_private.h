...
#define SPI1_BASE_ADD        ( ( volatile SPI_MemMap_t * )( 0x40013000 ) )
#define SPI2_BASE_ADD        ( ( volatile SPI_MemMap_t * )( 0x40003800 ) )
#define SPI3_BASE_ADD        ( ( volatile SPI_MemMap_t * )( 0x40003C00 ) )
#define SPI4_BASE_ADD        ( ( volatile SPI_MemMap_t * )( 0x40013400 ) )
